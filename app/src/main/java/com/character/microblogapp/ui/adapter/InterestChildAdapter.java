...
public class InterestChildAdapter extends ArrayAdapter {
    ...
    public InterestChildAdapter(Context context, ArrayList<Interest.Child> items, OnItemClickListener p_listener) {
        super(context, items);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ((ItemViewHolder) holder).m_info = (Interest.Child) getItem(position);
