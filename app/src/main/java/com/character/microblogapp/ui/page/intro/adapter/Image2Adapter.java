...
public class Image2Adapter extends ArrayAdapter {
    private Callback mCallback;
    public int PHOTO_MAX_COUNT = 8;

    public Image2Adapter(Context context, ArrayList items) {
        super(context, items);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new DefaultViewHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),R.layout.row_image1, parent, false).getRoot());
    }
    ...
    private void onBindViewHolders(DefaultViewHolder holder, final int position) {
        ...
        holder.spaceMiddle.setVisibility(View.VISIBLE);
