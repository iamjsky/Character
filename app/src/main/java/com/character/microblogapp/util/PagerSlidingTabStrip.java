...
//        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mTabsContainer.getChildCount() > 0) {
            mPaddingRight = getWidth() - mPaddingLeft;
        }
...
//            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorHeight > 0) {
            ...
            Pair<Float, Float> lines = getIndicatorCoordinates();
            canvas.drawRect(lines.first + mPaddingLeft + mTabPadding, height - mIndicatorHeight, lines.second + mPaddingLeft - mTabPadding, height, mRectPaint);
        }
    }
